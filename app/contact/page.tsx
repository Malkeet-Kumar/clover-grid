    ...
    <div className="min-h-screen">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">+91 98139-40038</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto divide-y divide-border bg-background shadow-sm">
            {[
              {
              ...
              },
              {
                ...
                answer:
                  "We can integrate with your existing team or work as an independent development partner.",
              },
            ].map((faq, index) => (
              <details
                key={index}
